...
export default function FeaturesPage() {
  return (
    <>
      <section className="bg-gradient-to-b from-brand-50 to-white px-4 pb-8 pt-16 text-center md:pt-20">
        <p className="text-sm font-semibold text-brand-600">기능 소개</p>
      ...
      <section className="px-4 py-12">
        <div className="mx-auto grid max-w-6xl gap-5 md:grid-cols-2">
          {FEATURES.map(({ icon: Icon, title, desc, points }) => (
            <article key={title} className="flex gap-5 rounded-2xl border border-stone-200 p-6">
              <div className="h-fit shrink-0 rounded-xl bg-brand-600/10 p-3 text-brand-600">
